table 50059 "Temp Item Ledger Entry"
{
    Caption = 'Temp Item Ledger Entry';
    DrillDownPageID = 38;
    LookupPageID = 38;
    ...
    keys
    {
        ...
        key(Key23; "Item No.", "Unit of Measure Code", "Nature of Disposal", "Entry Type")
        {
        }
        key(Key24; "Item No.", "Posting Date", "Unit of Measure Code", "Nature of Disposal", "Entry Type")
        {
        }
        key(Key25; "Item No.", "Nature of Disposal")
        {
        }
        key(Key26; "Entry Type", "Location Code", "External Document No.", "Item No.", "Order Type", "Order No.", "Order Line No.")
        {
            SumIndexFields = "Remaining Quantity";
        }
        key(Key27; "Entry Type", "Location Code", "External Document No.", "Order Type", "Order No.", "Order Line No.", "Item No.")
        {
        }
    }
