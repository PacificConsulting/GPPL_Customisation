codeunit 60003 "Calendar Generation"
{
    ...
    begin
        ...
        Holiday.SETRANGE("Operation Type", '1');
    ...
    begin
        ...
        IF TempCalendar.FIND('-') THEN
            REPEAT
                Weeklyoff.SETRANGE("Operation Type", '1');
    ...
    begin
        ...
        REPEAT
            ...
            IF DailyAttendance.FIND('-') THEN BEGIN
                ...
                MonthlyAttendance."Shortcut Dimension 1 Code" := Employee."Global Dimension 1 Code";  //EBT Paramita
                MonthlyAttendance."Shortcut Dimension 2 Code" := Employee."Global Dimension 2 Code";  //EBT Paramita
    ...
    // [Scope('Internal')]
    procedure CheckValidations2(): Boolean
    var
        Holiday: Record 60021;
        EmployeeShift: Record 60023;
        CheckDate: Date;
    ...
    begin
        ...
        Holiday.SETRANGE("Operation Type", '2');
        IF Holiday.FIND('-') THEN
            REPEAT
                IF (StartDate <= Holiday.Date) AND (EndDate >= Holiday.Date) THEN
                    Count2 := Count2 + 1
    ...
    begin
        ...
        IF TempCalendar.FIND('-') THEN
            REPEAT
                Weeklyoff.SETRANGE("Operation Type", '2');
                IF Weeklyoff.FIND('-') THEN
                    REPEAT
                        IF TempCalendar."Day No." = Weeklyoff."Day No." THEN BEGIN
                            TempCalendar."Non-Working" := TRUE;
