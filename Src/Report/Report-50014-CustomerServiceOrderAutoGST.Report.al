report 70014 "CustomerService Order-AutoGSTc"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/CustomerServiceOrderAutoGST.rdlc';

    Caption = 'Customer Service Order-AutoGST';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                column(MRP; 0)// "Sales Line"."MRP Price")
                {
                }
                column(BillingPrice; "List Price" + NDisPerLt)
                {
                }
                ...
                column(LineAMt; "Line Amount" + 0 + LineDiscAmt)
                {
                }
                column(LineCharge; 0 - LineDiscAmt)
                {
                }
                ...
                column(TotalAmt; "Line Amount" + 0 + 0 + 0 - "Line Discount Amount")
                {
                }
                ...
                column(ProductDiscountPerLtr; NDisPerLt)
                {
                }
                column(ProductDiscountAmount; NDisAmt)
                {
                }
                ...
                begin
                    ...
                    *///Commented DimensionTable#357---23Mar2017
                    ...
                    NDisPerLt := 0;
                    LineDiscAmt := 0;
                    IF "Sales Header"."Posting Date" <= 20190303D THEN BEGIN
                        NDisAmt := "National Discount Amount";
                        NDisPerLt := "National Discount Per Ltr";
                        LineDiscAmt := "National Discount Amount";
                    END ELSE BEGIN
                        NDisAmt := 0;
                        NDisPerLt := 0;
            ...
            begin
                ...
                IF "Sales Header"."Campaign No." = 'APPROVED' THEN BEGIN
                    ...
                    recSalesAppEntry.SETCURRENTKEY("Document No.", "Version No.");//19Dec2017
