report 70170 "Purchase Order- GST LOGOc"
{
    //     // Date        Version      Remarks
    //     // .....................................................................................
    //     // 26Feb2018   RB-N         Buy-From VendorNo State description
    //     DefaultLayout = RDLC;
    //     RDLCLayout = 'Src/Report Layout/PurchaseOrderGSTLOGO.rdl';

    //     Caption = 'Purchase Order- GST LOGO';
    ...
    //             column(HDisAmt07; HDisAmt07)
    //             {
    //             }
    //             column(HCAmt07; HCAmt07)
    //             {
    //             }
    //             column(POTEXT; POTEXT)
    //             {
    //             }
    ...
    //             {
    //             }
    //             column(VendorBillLoc; PH."Pay-to Address" + ' ' + PH."Pay-to Address 2" + ' ' + PH."Pay-to City" + ' ' + PH."Pay-to Post Code" + ' ' + State26.Description + ',  ' + RecCountry.Name)
    //             {
    //             }
    ...
    //             {
    //             }
    //             column(CompLogo; CompanyInfo1.Picture)
    //             {
    //             }
    ...
    //                 {
    //                 }
    //                 column(GSTBaseAmount; '"Purchase Line"."GST Base Amount"')
    //                 {
    //                 }
    ...
    //                 recStrOrderLineDet.SETRANGE(Type, recStrOrderLineDet.Type::Purchase);
    //                 recStrOrderLineDet.SETRANGE("Document Type", "Document Type");
    //                 recStrOrderLineDet.SETRANGE("Document No.", "No.");
    //                 IF recStrOrderLineDet.FINDSET THEN
    //                     REPEAT
    //                         IF recStrOrderLineDet."Tax/Charge Group" = 'DISCOUNT' THEN BEGIN
    //                             HDisAmt07 += recStrOrderLineDet.Amount;
    //                         END;

    //                         IF recStrOrderLineDet."Tax/Charge Group" = 'FREIGHT' THEN BEGIN
    //                             HCAmt07 += recStrOrderLineDet.Amount;
    //                         END;
    //                     UNTIL recStrOrderLineDet.NEXT = 0;
    //                 //<<07July2018 StrucureDetails

    //                 //>>
    //                 IF PH."Work Order" THEN
    //                     POTEXT := 'WORK ORDER'
    //                 ELSE
    //                     POTEXT := 'PURCHASE ORDER';
    //                 //<<

    //                 //>>26Feb2018
    //                 Ven26.RESET;
    //                 IF Ven26.GET(PH."Buy-from Vendor No.") THEN
    //                     State26.RESET;
    //                 IF State26.GET(Ven26."State Code") THEN;
