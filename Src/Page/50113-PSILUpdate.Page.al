    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                // field("Supplimentary Invoicerec."; "rec.Supplimentary Invoice")
                // {
                //     ApplicationArea = all;
                // }
                // field("Final Item No."; rec."Final rec.Irec.tem No.")
                // {
                //     ApplicationArea = all;
                // }
                field("Final Line No."; rec."Final Line No.")
                {
                    ApplicationArea = all;
                }
                ...
                field("National Discount Per Ltr"; rec."National Discount Per Ltr")
                {
                    ApplicationArea = all;
                }
                ...
                field("Price Support Amount"; rec."Price Support Amount")
                {
                    ApplicationArea = all;
                }
            }
