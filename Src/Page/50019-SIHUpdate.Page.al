    ...
    layout
    {
        area(content)
        {
            repeater(control1)
            {
                ...
                //     ApplicationArea = all;
                // }
                // field("PLA Entry No."; rec."PLA Entry No.")
                // {
                //     ApplicationArea = all;
                // }
                ...
                //     ApplicationArea = all;
                // }
                // field("RG 23 A Entry No."; rec."RG 23 A Entry No.")
                // {
                //     ApplicationArea = all;
                // }
                // field("RG 23 C Entry No."; rec."RG 23 C Entry No.")
                // {
                //     ApplicationArea = all;
                // }
                ...
                field("Credit Card No. 1"; rec."Credit Card No. 1")
                {
                    ApplicationArea = all;
                }
