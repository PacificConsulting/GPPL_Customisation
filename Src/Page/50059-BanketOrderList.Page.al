    ...
    layout
    {
        area(content)
        {
            repeater(group)
            {
                ...
                //     ApplicationArea = all;
                // }
                // field("SetOff Available"; rec."SetOff Available")
                // {
                //     ApplicationArea = all;
                // }
                ...
                //     ApplicationArea = all;
                // }
                // field("SHE Cess on TDS Amount"; rec."SHE Cess on TDS Amount")
                // {
                //     ApplicationArea = all;
                // }
                ...
                field("Balance Qty To Receive"; rec."Balance Qty To Receive")
                {
                    ApplicationArea = all;
                }
                ...
                field("Modify Through WH"; rec."Modify Through WH")
                {
                    ApplicationArea = all;
                }
                field("Unit Cost Update"; rec."Unit Cost Update")
                {
                    ApplicationArea = all;
                }
                field("Bulk Packing"; rec."Bulk Packing")
                {
                    ApplicationArea = all;
                }
