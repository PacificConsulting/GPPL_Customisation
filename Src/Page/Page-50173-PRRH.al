    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Warehouse Handling Time"; rec."Warehouse Handling Time")
                {
                    ApplicationArea = all;
                }
                ...
                //     ApplicationArea = all;
                // }
                // field("Authorized User ID"; rec."Authorized User ID")
                // {
                //     ApplicationArea = all;
                // }
                ...
                //     ApplicationArea = all;
                // }
                // field("Sales Return Type"; rec."Sales Return Type")
                // {
                //     ApplicationArea = all;
                // }
