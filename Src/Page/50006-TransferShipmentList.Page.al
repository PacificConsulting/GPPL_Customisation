page 50006 "Transfer Shipment List"
{
    Editable = false;
    PageType = List;
    SourceTable = 5744;
    ...
    layout
    {
        area(content)
        {
            repeater(control01)
            {
                ...
                field("Transfer From User City"; rec."Transfer From User City")
                {
                    ApplicationArea = all;
                }
                field("Transfer From User State"; rec."Transfer From User State")
                {
                    ApplicationArea = all;
                }
                field("Transfer From User Zone"; rec."Transfer From User Zone")
                {
                    ApplicationArea = all;
                }
                field("Transfer To User City"; rec."Transfer To User City")
                {
                    ApplicationArea = all;
                }
                field("Transfer To User State"; rec."Transfer To User State")
                {
                    ApplicationArea = all;
                }
                field("Transfer To User Zone"; rec."Transfer To User Zone")
                {
                    ApplicationArea = all;
                }
                ...
                field("Local Vehicle for Location"; rec."Local Vehicle for Location")
                {
                    ApplicationArea = all;
                }
                ...
                field("F Form Status"; rec."F Form Status")
                {
                    ApplicationArea = all;
                }
