page 50038 "Discounts & Incentives"
{
    DelayedInsert = true;
    DeleteAllowed = false;
    InsertAllowed = true;
                ...
                action("Su&bmit")
                {
                    ...
                    begin
                        ...
                        REPEAT
                          ...
                          Discounts."TPT Type" := Discounts."TPT Invoice Date" * Discounts."From Location Name";
                          Discounts.MODIFY;
                ...
                action("Create &Credit Memo")
                {
                    ...
                    begin
                        ...
                        BEGIN
                          ...
                          Discounts.SETRANGE(Discounts."Expected TPT Cost","Expected TPT Cost");
                          Discounts.SETRANGE(Discounts."To Location Name",FALSE);
                          Discounts.SETFILTER(Discounts."TPT Type",'<>%1',0);
                          IF Discounts.FINDSET THEN
                          REPEAT
                        ...
                        Discounts.RESET;
                        Discounts.SETFILTER(Discounts."Freight Type",'<>%1','');
                        IF Discounts.FINDSET THEN
                           Discounts.MODIFYALL(Discounts."To Location Name",TRUE);
                        */
